 ...
 */
import { TECHNICAL_CATEGORY_SLUG } from "./default-categories";

export const CATALOG_ASSIGNABLE_SERVICE_CATEGORY_SLUGS = [TECHNICAL_CATEGORY_SLUG, "professional"] as const;
