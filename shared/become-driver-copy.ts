...
export const BECOME_DRIVER_SECTION_OFFER = "Tu oferta (taxi y delivery)";

export const BECOME_DRIVER_OFFER_KIND_LABEL = "Tipo de oferta (subcategoría)";

export const BECOME_DRIVER_OFFER_KIND_DESCRIPTION =
  "Indica si operas con moto, carro o camioneta; define el tipo base de tu vehículo en mapas y paneles Go (misma lógica que en Become Pro).";

export const BECOME_DRIVER_OFFER_TITLE_LABEL = "Nombre público de la oferta";

export const BECOME_DRIVER_OFFER_TITLE_PLACEHOLDER = "Ej. Traslados aeropuerto y paquetería express";

export const BECOME_DRIVER_OFFER_DESCRIPTION_LABEL = "Descripción de la oferta";

export const BECOME_DRIVER_OFFER_DESCRIPTION_PLACEHOLDER =
  "Qué incluye taxi y qué aceptas en delivery, horarios, límites…";

export const BECOME_DRIVER_VEHICLE_SECTION_TITLE = "Datos del vehículo";
...
export const BECOME_DRIVER_REDIRECT_MOBILITY_TITLE = "Ya tienes categoría de movilidad";

export const BECOME_DRIVER_REDIRECT_MOBILITY_BODY =
  "Tu perfil principal ya está registrado como taxi o delivery. Ajusta tu oferta o tu vehículo desde Mis servicios o Configuración.";

export const BECOME_DRIVER_REDIRECT_DONE_TITLE = "Registro de conductor completo";
