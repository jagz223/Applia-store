...
import { MODAL_CONTENT_ABOVE_OVERLAY, MODAL_Z_ALERT_SHELL } from "@/lib/modal-layer-z"
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      "absolute inset-0 bg-black/70 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className,
    )}
    {...props}
    ref={ref}
...
>(({ className, overlayClassName, ...props }, ref) => (
  <AlertDialogPortal>
    <ModalPortalShell
      zIndexClass={MODAL_Z_ALERT_SHELL}
      overlay={
        <AlertDialogOverlay
