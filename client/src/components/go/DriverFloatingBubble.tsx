...
export function DriverFloatingBubble() {
  ...
  const { supported, overlaySupported, active, shellCollapsed, isMinimized, pipActive, receiveMode, receiving, expand } =
    useGoDriverBubble();
  ...
  if (!supported || !overlaySupported || !active || !onDriverMainView || !isMinimized || pipActive) return null;
